...
import BoardChallengeRender from './rankComponents/BoardChallengeRender'
  ...
  return (
    ...
    <div className="dashBoard-Sidebar-Wrapper">
      <ul>
        ...
        <li className="dashBoard-option">
          <button
          onClick={() => handleContentChange("Learning")}
          className={getButtonClass("Learning")}
          >
    ...
    <div className="dashboard-content-render">
      ...
      {activeContent === "Learning" && < Lesson />}
      {activeContent === "Rank" && < BoardChallengeRender />}
      {activeContent === "Excercise" && < ExerciseList />}
      {activeContent === "Compiler" && < BoardChallengeRender />}
