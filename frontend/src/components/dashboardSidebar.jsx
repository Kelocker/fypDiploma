...
//         <li className="dashBoard-option">
//           <button
//           onClick={() => handleContentChange("Lesson")}
//           className={getButtonClass("Lesson")}
//           >
...
const DashboardSidebar = () => {
  ...
  const [activeContent, setActiveContent] = useState(localStorage.getItem('activeContent') || "Lesson");
  ...
  const getButtonClass = (content) => (activeContent === content ? 'active' : '');
  ...
  return (
    <div className="dashboard-content">
      <div className="dashBoard-Sidebar-Wrapper">
        <ul>
          <li className="dashBoard-option-special">
            <button onClick={() => handleContentChange("Preference")} className={getButtonClass("Preference")}>
              <img className="dashboard-profile" src="/defaultProfilePicture.jpg" alt="" />
              {userData.username}
          ...
          <li className="dashBoard-option">
            <button onClick={() => handleContentChange("Lesson")} className={getButtonClass("Lesson")}>
              <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24">
          ...
          <li className="dashBoard-option">
            <button onClick={() => handleContentChange("Excercise")} className={getButtonClass("Excercise")}>
              <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24">
          ...
          <li className="dashBoard-option">
            <button onClick={() => handleContentChange("Rank")} className={getButtonClass("Rank")}>
              <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24">
          ...
          <li className="dashBoard-option">
            <button onClick={() => handleContentChange("Compiler")} className={getButtonClass("Compiler")}>
              <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24">
